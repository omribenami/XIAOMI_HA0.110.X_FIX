...
DATA_KEY = 'switch.xiaomi_gateway_alarm'
...
class XiaomiMiioGenericDevice(SwitchEntity):
    ...
    def __init__(self, device, config, device_info):
        ...
        self._state_delay_value = config.get(CONF_STATE_DELAY_VALUE)
    ...
    async def async_update(self):
        ...
        try:
            ...
            if state == self._state_on_value:
                self._state = True
            elif state == self._state_delay_value:
                self._state = True
                ...
                _LOGGER.warning(
                    ...
                    state, self._state_on_value, self._state_delay_value, self._state_off_value)
                self._state = None
